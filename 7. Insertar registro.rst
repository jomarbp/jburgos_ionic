...
5. En el navegador ir a la ruta **http://localhost/api/autoincrementar_codigo.php**
...
6. deberá actualizar los códigos respetando la estructura que se autoincrementará
